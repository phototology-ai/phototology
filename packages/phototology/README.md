...
To prevent name confusion. Without it, `npm install phototology` could resolve to a typo-squat or an unrelated package. This package locks the name and points to the real ones.

## Source

The source for all Phototology packages lives at [github.com/phototology-ai/phototology](https://github.com/phototology-ai/phototology). This package corresponds to `packages/phototology/` in that repo.
